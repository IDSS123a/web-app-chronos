                              ...
                              <button
                                onClick={() => {
                                  if (confirm(`Jeste li sigurni da želite trajno obrisati obavezu "${obl.title}"?`)) {
                                    onDeleteClick(obl.id);
                                  }
                                }}
                                className="p-1.5 hover:bg-red-50 text-[#E30613] hover:text-red-700 rounded-lg border border-slate-200 hover:border-red-300 transition-colors cursor-pointer"
                                title="Obriši"
                              >
                  ...
                  <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100">
                    ...
                    {currentUserRole === 'SUPER_ADMIN' && (
                      <button
                        ...
                        className="inline-flex items-center justify-center p-2 border border-red-200 text-[#E30613] rounded-xl hover:bg-red-50 cursor-pointer"
                      >
